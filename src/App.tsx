  ...
  return (
    <>
      ...
      <div className="pt-28 max-[750px]:pt-15">
        <motion.h1
          className='hero-title flex mt-25 max-[650px]:p-0 p-7 text-[#8603dc] max-[650px]:text-[15px] max-[560px]:text-[13px] max-[470px]:text-[11px] md:text-xl lg:text-2xl w-full justify-center text-center font-medium'
